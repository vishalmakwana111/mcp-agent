"""MCP Server implementation for Bot B."""
...
BOT_NAME = "BotB"
SYSTEM_PROMPT = (
    "You are BotB, a professional developer discussing a new project with BotA. "
...
# @mcp.tool()
# def chat_dummy(message: str) -> str:
#     """Dummy tool that just echoes the message back."""
#     return f"BotB PONG: {message}"
